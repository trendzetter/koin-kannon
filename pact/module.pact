...
(module test-kannon-v5 GOVERNANCE
  ...
  (defconst GOVERNANCE_KEYSET:string 
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account (create-principal GOVERNANCE_KEYSET) GOVERNANCE_KEYSET)
      (update token-table (create-principal GOVERNANCE_KEYSET) { "balance" : INITIAL_SUPPLY })
    )
  )
